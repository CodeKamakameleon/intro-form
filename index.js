...
const trialForm = document.querySelector(".form-group");

const trialFormValidatorinator = new FormValidateinator(selectors, trialForm);
trialFormValidatorinator.enableValidation();
